...
excerpt: ""
---
One thing all signature hash types sign is the transaction's <<glossary:locktime>>. (Called nLockTime in the Dash Core source code.) The locktime indicates the earliest time a transaction can be added to the block chain.
