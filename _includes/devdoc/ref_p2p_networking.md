...
|---------|------------------------------------|--------------
| 70216  | Dash Core 0.15.0 <br>(Q1 2020)  | • Mempool sync (via `mempool` message)<br>• Updated default P2P/RPC ports for RegTest and Devnet networks<br>• Removal of `alert` message<br>• Removal of legacy InstantSend<br>• Removal of sporks 5 and 12<br>• Deprecation of sporks 15, 16, and 20
